...
// @public (undocumented)
export type DevtoolsLiveQueryScope = "all" | "runtime.summary" | "runtime.activeQueries" | "schema.tables" | "scheduler.jobs" | "storage.objects" | `table:${string}` | `storage:${string}`;
...
// @public
export type ImpactScope = "runtime.summary" | "runtime.activeQueries" | "schema.tables" | "scheduler.jobs" | "storage.objects" | `table:${string}` | `row:${string}:${string}` | `storage:${string}`;
...
// Warning: (ae-forgotten-export) The symbol "Expand_2" needs to be exported by the entry point index.d.mts
// Warning: (ae-forgotten-export) The symbol "OptionalKeys" needs to be exported by the entry point index.d.mts
// Warning: (ae-forgotten-export) The symbol "RequiredKeys" needs to be exported by the entry point index.d.mts
//
// @public
...
// @public
export interface SyncoreDataModel<TTables extends SyncoreSchemaDefinition = SyncoreSchemaDefinition> {
    // (undocumented)
...
// @public (undocumented)
export interface SyncoreRuntimeAdmin<TSchema extends SyncoreDataModel = SyncoreDataModel> {
    // (undocumented)
