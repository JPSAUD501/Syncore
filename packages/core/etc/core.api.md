...
// @public (undocumented)
export function createDevtoolsRequestHandler(deps: DevtoolsRequestHandlerDeps): DevtoolsRequestHandler;
...
// Warning: (ae-forgotten-export) The symbol "SyncoreRequestPayload" needs to be exported by the entry point index.d.mts
// Warning: (ae-forgotten-export) The symbol "SyncoreResponsePayload" needs to be exported by the entry point index.d.mts
//
// @public (undocumented)
export type DevtoolsRequestHandler = (payload: SyncoreRequestPayload) => Promise<SyncoreResponsePayload>;
