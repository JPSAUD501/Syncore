...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-fit items-center justify-between gap-2 rounded-md border border-border bg-bg-base px-3 py-2 text-[13px] text-text-primary whitespace-nowrap transition-colors outline-none",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-[13px] text-text-secondary outline-hidden select-none",
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <ChevronUpIcon className="size-4 text-text-tertiary" />
    </SelectPrimitive.ScrollUpButton>
  );
}
