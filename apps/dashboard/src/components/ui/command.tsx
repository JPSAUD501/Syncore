  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "flex h-10 w-full rounded-md bg-transparent py-3 text-[13px] text-text-primary outline-hidden placeholder:text-text-tertiary disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        {...props}
      />
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-md px-2 py-1.5 text-[13px] text-text-secondary outline-hidden select-none",
